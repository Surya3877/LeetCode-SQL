...
| price         | int     |
+---------------+---------+
(product_id, start_date, end_date) is the primary key (combination of
...
Write a solution to find the avering selling price for each product. average_price should be
rounded to 2 decimal places. if a product does not have any sold units, its average selling price
is assumed to be 0.
...
CREATE DATABASE IF NOT EXISTS 1251_Average_Selling_Price;
USE 1251_Average_Selling_Price;
...
INSERT INTO UnitsSold (product_id, purchase_date, units) VALUES ("1", "2019-02-25", "15");
...
should be rounded to 2 decimal places. If a product does not have any sold units, its average selling price
is assumed to be 0.
*/
